...
export default function Example() {
  return (
    <Disclosure
      as="nav"
      className="bg-white shadow-md  py-2  border-b-2"
    >
      {({ open }) => (
        <>
          <div className=" max-w-7xl px-2 sm:px-6 lg:px-8 ">
            <div className="relative flex p-2 items-center justify-between">
              <div className="absolute inset-y-0 right-0 flex items-center sm:hidden">
                {/* Mobile menu button*/}
                <Disclosure.Button className="relative inline-flex items-center justify-center rounded-md p-2 text-black hover:bg-slate-500 hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
                      ...
                      {navigation.map((item) => (
                        <a
                          ...
                          className={classNames(
                            ...
                            "rounded-2xl px-3 py-2 text-xl font-normal"
                          )}
