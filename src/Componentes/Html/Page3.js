...
const Page3 = () => {
  ...
  return (
    <>
      {/* <div className="container flex flex-wrap p-6 items-center overflow-hidden"> */}
      ...
      <div className="w-auto h-auto mt-3 rounded-3xl p-3">
        ...
        >
          ...
          <li className="text-xl my-1 leading-tight text-justify">
            ...
            because it can be displayed on any platform like windows, linux, and
            Macintosh, etc.
          </li>
          <li className="text-xl my-1 leading-tight text-justify">
          ...
          <li className="text-xl my-1 leading-tight text-justify">
            ...
            language, which means we can use tags either in lower-case or upper-case.
          </li>
          <li className="text-xl my-1 leading-tight text-justify">
            ...
            on the web(by html anchor tag),so it enhances the interest of browsring of the user.
          </li>
        </ul>
      </div>
      {/* </div> */}
